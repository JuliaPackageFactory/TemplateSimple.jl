...
See `[compat]` in [Project.toml](https://github.com/JuliaPackageFactory/TemplateSimple.jl/blob/main/Project.toml)
...
```@repl
import TemplateSimple; TemplateSimple.hello()
```
