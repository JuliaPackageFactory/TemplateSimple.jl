...
[![Stable](https://img.shields.io/badge/docs-stable-blue.svg)](https://ohno.github.io/Simple.jl/stable/)
[![Dev](https://img.shields.io/badge/docs-dev-blue.svg)](https://ohno.github.io/Simple.jl/dev/)
[![CI](https://github.com/ohno/Simple.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/ohno/Simple.jl/actions/workflows/CI.yml?query=branch%3Amain)
[![coverage](https://codecov.io/gh/ohno/Simple.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/ohno/Simple.jl)

PkgFactory simple template integration test
...
```julia
import Pkg; Pkg.add(url="https://github.com/ohno/Simple.jl.git")
```

After installation, run the following to load the package and verify it works:

```@repl
import Simple; Simple.hello()
```
